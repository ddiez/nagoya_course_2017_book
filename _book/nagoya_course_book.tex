...
\section{Sequence analysis}\label{sequence-analysis}

\section{Omics analysis}\label{omics-analysis}

\section{Structural analysis}\label{structural-analysis}

\chapter{Sequence analysis}\label{sequence-analysis-1}

\section{Introduction}\label{introduction}

\section{Two sequence alignment}\label{two-sequence-alignment}

\subsection{Comparing two sequences of different
lengths}\label{comparing-two-sequences-of-different-lengths}

\subsection{Smith-waterman (global
alignment)}\label{smith-waterman-global-alignment}

\subsection{Needleman- (local
alignment)}\label{needleman--local-alignment}
...
\section{Phylogenetic methods}\label{phylogenetic-methods}
